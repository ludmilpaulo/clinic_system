...
from .views import PasswordResetView, PasswordResetConfirmView, UserOrdersView, UserProfileView, UserSignupView, UserLoginView, get_user_profile, update_user_profile
